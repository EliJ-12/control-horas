                        ...
                        <tr key={`${event.eventType}-${event.id}`} className="border-b last:border-0 hover:bg-muted/20 transition-colors">
                          ...
                          <td className="p-4">
                            {event.isAutoGenerated && (
                              <span className="px-2 py-0.5 rounded-full text-[10px] font-medium border bg-orange-50 text-orange-700 border-orange-100">
                                Automático
                              </span>
                            )}
                            {!event.isAutoGenerated && (
                              <span className="px-2 py-0.5 rounded-full text-[10px] font-medium border bg-gray-50 text-gray-700 border-gray-100">
                                Manual
                              </span>
                            )}
                          </td>
