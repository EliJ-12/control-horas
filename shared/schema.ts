...
export const workLogs = pgTable("work_logs", {
  ...
  isAutoGenerated: boolean("is_auto_generated").default(false), // NEW: Identify auto-generated records
  slotId: integer("slot_id").default(1), // NEW: Slot ID for multiple auto-records per day
  createdAt: timestamp("created_at").defaultNow(),
});
...
export const autoTimeSettings = pgTable("auto_time_settings", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id).notNull(), // Removed unique constraint to allow multiple slots
